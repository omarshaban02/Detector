...
class Application(QMainWindow, Ui_MainWindow):
    ...
    def setup_hough_sliders(self):
        ...
        for hough_slider, hough_param in self.dict_line_sliders.items():
            hough_slider.valueChanged.connect(lambda value, hough_slider = hough_slider: hough_param = value)
