...
class Application(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        dict_circle_sliders = {
            self.slider_circle_min_radius : self.hough_rho,
            self.slider_circle_max_radius : self.hough_theta,
            self.slider_circle_threshold : self.hough_threshو
            self.slider_circle_min_dist : self.hough_thresh
        }
