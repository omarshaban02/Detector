...
class Application(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.scatter_item = pg.ScatterPlotItem(x=(1, 1), y=(1, 1), pen="green", symbol="x", size=20)
    ...
    def on_mouse_click(self, ev):
        clicked_point = self.wgt_contour_input.plotItem.vb.mapSceneToView(ev.scenePos())
