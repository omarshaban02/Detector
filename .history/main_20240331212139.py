...
class Application(QMainWindow, Ui_MainWindow):
    ...
    def setup_hough_sliders(self):
        ...
        for hough_slider, circle_slider in zip(dict_hough_sliders.keys, dict_circle_sliders.keys):
            hough_slider.valueChanged.connect(lambda value, hough_slider=hough_slider: dict_hough_sliders[hough_slider] = value)
